...
java -Djava.library.path="javafx-jars" --module-path "javafx-jars" --add-modules javafx.controls,javafx.fxml -jar target\enigma-simulator-1.0.0-jar-with-dependencies.jar
